...
?>
    <!-- Header -->
                ...
                <div class="intro-text">     
                    ...
                    <div class="intro-lead-in">
                        <div class="user">
                            ...
                            <!-- Avatar  -->
                            <div class="avatar">
                                <img src="img/avatar.png" class="img-responsive" style="display: inline-block; width: 140px;" alt="avatar"> <a href="#services" class="fa fa-camera"></a><br>
                            </div>
                            <!-- Nom & Prénom -->
                            <div>
        ...
        <div class="container">
            ...
            <!-- Affichage des différentes ? utilisateur  -->
            <section>
                                ...
                                {                                   
                                    echo '<li>';
                                        echo '<div class="timeline-image">';
                                                echo '<img style="max-width: 100%; height: 100%;" class="img-circle img-responsive" src="' . URL . 'photo/' . $article['photo'] . '" alt="">';
                                        echo '</div>';
                            ...
                            <div class="col-xs-4">
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <span>Pseudo: </span><?php echo $_SESSION['utilisateur']['pseudo'];?>
                                    </li>
                                    <li class="list-group-item">
                                        <span>Nom: </span><?php echo $_SESSION['utilisateur']['lastname'];?>
                                    </li>
                                    <li class="list-group-item">
                                        <span>Prénom: </span><?php echo $_SESSION['utilisateur']['firstname'];?>
                                    </li>
                                    <li class="list-group-item">
                                        <span>Email: </span><?php echo $_SESSION['utilisateur']['email'];?>
                                    </li>	
                                    <li class="list-group-item" style="text-align:center;"> 
                                            <a onclick="return(confirm(\'MODIFIER VOTRE PROFIL ?\'));" href="?action=modification&id='.$users['id'].'" type="button" class="btn btn-primary">Modifier votre compte</a>  
                                    </li>
                                </ul>
                            </div>
                                <div class="col-xs-4">
