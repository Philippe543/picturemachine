    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <div class="intro-lead-in">Rejoignez-nous pour <br>
                                           <br>échanger, se passionner, imaginer et partager.</div>
                                           <br>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <p class="text-muted">Hier/aujourdhui, vues comparées du temps qui est passé, des hommes qui ont vécu, des pierres qui se sont usées.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="text-muted">Il n’y a pas d’erreur, la mode est au partage. </i>Depuis plusieurs années, on entend parler de nouvelles tendances dont l’analyse montre clairement la place de l’humain par la satisfaction de donner quelque chose à autrui et à la fois à lui-même.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
...
<section id="story">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Les Stories <i class="fa fa-smile-o"></i></h2>
                    <h3 class="section-subheading text-muted">Il y a de grande chance pour que vos photos  .</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
			...
			<div class="row">
				...
				<div class="col-sm-10">
					...
					while($article = $liste_article->fetch(PDO::FETCH_ASSOC))
					{
						...
						echo '<h5>' . $article['country'] . '</h5>';
						echo '<br>'.$article['city'] .'&nbsp'. $article['date_picture'] . '<br>';
                    ...
                    echo '<a href="" title="Coast Valley">';
                    echo ' <img height ="200" src="' . URL . 'photo/' . $article['photo'] . '" alt="Coast Valley"title="Coast Valley"/>';
                    echo '</a>';
                    ?>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="team-member">
                        <div id="hover">
                            <img src="img/team/to.webp" class="img-responsive img-circle" alt="">
                            <!-- hover: <img src="img/team/a5.gif" class="img-responsive img-circle" alt=""> -->
                            <h4>Alexandre Largent</h4>
                            <p class="text-muted">&#201;tudiant Webforce3</p>
                            <ul class="list-inline social-buttons">
                                <li><a href="https://github.com/ALEXLARG"><i class="fa fa-github"></i></a>
                                </li>
                ...
                <div class="col-sm-3">
                    <div class="team-member">
                        ...
                        <p class="text-muted">&#201;tudiant Webforce3</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="#https://github.com/4lex4ndre-F"><i class="fa fa-github"></i></a>
                            </li>
                            <li><a href="https://fr-fr.facebook.com/"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li><a href="https://www.linkedin.com/"><i class="fa fa-linkedin"></i></a>
                ...
                <div class="col-sm-3">
                    <div class="team-member">
                        ...
                        <p class="text-muted">&#201;tudiant Webforce3</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="https://github.com/Tanguyman"><i class="fa fa-github"></i></a>
                            </li>
                            <li><a href="https://fr-fr.facebook.com/"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li><a href="https://www.linkedin.com/"><i class="fa fa-linkedin"></i></a>
                ...
                <div class="col-sm-3">
                    <div class="team-member">
                        ...
                        <p class="text-muted">&#201;tudiant Webforce3</p>
                        <ul class="list-inline social-buttons">
                            <li><a href="https://github.com/Philippe543"><i class="fa fa-github"></i></a>
                            </li>
                            <li><a href="https://fr-fr.facebook.com/"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li><a href="https://www.linkedin.com/"><i class="fa fa-linkedin"></i></a>
